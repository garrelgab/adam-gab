    ...
    <div className='bg-[#2a2a2a] py-[50px] md:py-[100px] text-justify  text-white md:drop-shadow-md' id='company'>
        <div className='mx-auto max-w-[1240px]'>
            <div className='mx-[30px] text-white'>
                ...
                <h1 className='flex text-center justify-center mt-[30px]'>We are here to equip and empower you in this journey of reaching your full potential and being who you really want to be. We support people of all sizes and genders as we want to be part of your journey to reach your own goals.</h1>

            </div>
        </div>        {/* <div className='max-w-[1240px] mx-auto p-5 grid md:grid-cols-2 justify-center rounded-2xl'>
            <div className=''>

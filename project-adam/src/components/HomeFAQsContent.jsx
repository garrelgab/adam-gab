    ...
    <div className='bg-[#2a2a2a] flex flex-col justify-center items-center py-[50px] shadow-lg'>
        ...
        <div className='flex flex-col mx-[40px] md:w-[1240px] mt-[40px] text-white'>
            ...
            <div className='ml-[50px] mt-[50px] text-justify'>
                <h1 className='text-[20px] text-[#93F4D3]'>How can I create my own account?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What if I forgot my password?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How much does it cost a membership plan?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What does my membership include?</h1>
...
ADAM Fitness also provides a free parking area, Wi-Fi access, unlimited use of the shower room, and a rent locker for our dear customers.
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How can I cancel my membership plan?</h1>
...
Please contact to the gym admin directly for more information or please send us an email at adamfitnesscenter@gmail.com</p>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How can I change my order?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What are your online reservation and scheduling rules?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What is your mode of payment?</h1>
                <p className='mt-[10px]'>We accept payments through G-Cash only and cash if you go directly to the gym.</p>

                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What will happen if I don’t show up for a class?</h1>

  ...
  return (
    <div className='flex justify-between items-center px-4 w-full mx-auto text-white border-b border-b-gray-500 md:grid-flow-col-3 p-1'>
        ...
        <div className='hidden md:flex mr-2'>
            <button className='font-normal bg-[#93F4D3] hover:outline hover:outline-offset-0 hover:bg-[#19313800] text-black hover:text-white rounded-md w-[90px] ml-2 my-2 py-2 ease-in-out duration-300'

...
const PrivacyPolicyContent = () => {
  return (
    <div className='bg-[#2a2a2a] flex flex-col justify-center items-center py-[50px] shadow-lg'>
        {/* <h1 className='text-[30px] text-white'>ADAM Fitness Center</h1> */}
        <h1 className='flex md:flex md:text-[50px] text-[30px] text-white md:mt-[50px] font-extrabold '>ADAM<p className='text-[#93F4D3] px-[5px]'>FITNESS</p>CENTER</h1>
        
        <div className='flex flex-col mx-[40px] md:w-[1240px] mt-[40px] text-white'>
            ...
            <div className='ml-[50px] mt-[50px] text-justify'>
                <h1 className='text-[20px] text-[#93F4D3]'>Purpose of Privacy Policy</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Who we are</h1>
                ...
                <div className='ml-[50px]'>
                    <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Third Party Links</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>What information do we collect?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How do we use your information?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How do we use your email information?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How do we use your phone number?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How do we access and update your data?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>How we protect your data?</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Filling Out Your Info</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Making a Purchase</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Z.com Philippines</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>Changes To This Policy</h1>
                ...
                <h1 className='text-[20px] text-[#93F4D3] mt-[30px]'>HOW TO CONTACT US.</h1>

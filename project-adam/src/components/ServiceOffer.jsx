...
const ServiceOffer = () => {
  return (
    <div className='py-[20px] md:py-[90px] drop-shadow-md shadow-md' id='services'>
        ...
        <div className='mx-[30px] md:flex md:flex-col-4 justify-center text-white'>
            <LinkScroll to='danceStudio' spy={true} smooth={true} offset={-150} duration={500}>
                <div className='bg-[#1ca350] h-[200px] md:h-[300px] md:w-[300px] rounded-2xl flex justify-center items-center my-4 md:mx-4 md:my-0 cursor-pointer'>

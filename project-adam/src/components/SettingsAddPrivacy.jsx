...
const SettingsAddPrivacy = (props) => {
    ...
    <div className='fixed flex align-middle justify-center pt-[50px] top-0 left-0 w-[100%] h-[100%] bg-modal z-50'>
        <div className='text-black w-[300px] md:w-[900px] h-[550px] mt-[50px] z-50 bg-[#93F4D3] rounded-md shadow-xl'>
            ...
            <div className=' mx-[30px]'>
                <h1 className='md:text-[25px] font-bold'>Add Privacy Policy</h1>
                ...
                <div className='flex justify-end mt-[30px]'>
                    <button className='w-[150px] p-2 text-lg font-light rounded-md bg-gray-600 hover:bg-gray-800 text-white shadow-lg hover:shadow-xl ease-in-out duration-300' onClick={handleAddPrivacy}>Add</button>
                </div>
            </div>
        </div>
    </div>
...
export default SettingsAddPrivacy